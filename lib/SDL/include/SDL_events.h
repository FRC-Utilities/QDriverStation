...
typedef enum
{
    ...
    SDL_APP_WILLENTERBACKGROUND, /**< The application is about to enter the
                          ...
                          */
    SDL_APP_DIDENTERBACKGROUND,  /**< The application did enter the background and
                               may not get CPU for some time
                                 Called on iOS in
                               applicationDidEnterBackground()
                                 Called on Android in onPause()
                            */
    SDL_APP_WILLENTERFOREGROUND, /**< The application is about to enter the
                              foreground
                               Called on iOS in
    ...
    SDL_CONTROLLERDEVICEADDED,   /**< A new Game controller has been inserted into
                                the system */

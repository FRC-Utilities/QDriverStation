 ...
 *
 * \return 0 on success, SDL_INVALID_SHAPE_ARGUMENT on invalid an invalid shape
 *argument, or SDL_NONSHAPEABLE_WINDOW
 ...
 *shape_mode has been filled with the mode
 *           data, SDL_NONSHAPEABLE_WINDOW if the SDL_Window given is not a
 *shaped window, or SDL_WINDOW_LACKS_SHAPE if
 *           the SDL_Window* given is a shapeable window currently lacking a
 *shape.
 *
 * \sa SDL_WindowShapeMode

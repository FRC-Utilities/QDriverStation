...
typedef enum
{
    ...
    SDL_WINDOWEVENT_SIZE_CHANGED, /**< The window size has changed, either as a
 ...
 *          was available.
 *
 *  The available display modes are scanned, and \c closest is filled in with
 *the
 ...
 *  \sa SDL_GetDisplayMode()
 */
extern DECLSPEC SDL_DisplayMode* SDLCALL
 ...
 *  \param grabbed This is SDL_TRUE to grab input, and SDL_FALSE to release
 *input.
 *
 *  \sa SDL_GetWindowGrab()
 */
...
/**
 *  \brief Reset all previously set OpenGL context attributes to their default
 * values
 */

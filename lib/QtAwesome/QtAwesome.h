...
enum icon
{
    ...
    android              = 0xf17b,
    angellist            = 0xf209,
    anglefloatdown      = 0xf103,
    anglefloatleft      = 0xf100,
    anglefloatright     = 0xf101,
    anglefloatup        = 0xf102,
    angledown            = 0xf107,
    angleleft            = 0xf104,
    angleright           = 0xf105,
...
public:
    ...
    QIcon icon (QtAwesomeIconPainter* painter,
...
private:
    ...
    QHash<QString, QtAwesomeIconPainter*>
    painterMap_;     ///< A map of custom painters
    QVariantMap
    defaultOptions_;                           ///< The default icon options
    QtAwesomeIconPainter*
    fontIconPainter_;                ///< A special painter fo painting codepoints
};
